...
const SYSTEM_MESSAGE = {
  id: '0',
  text: "Hello! I'm **MentalBuddy**, your mental health companion. I'm here to listen and help. How are you feeling right now?",
  sender: 'bot',
  timestamp: new Date(),
};
    ...
    try {
      if (text.toLowerCase().includes('which model') || text.toLowerCase().includes('what model')) {
        const botMessage = {
          ...
          text: "I'm **MentalBuddy** - your mental health companion powered by AI.",
          sender: 'bot',
          timestamp: new Date(),
        };
      ...
      const systemPrompt = {
        role: 'user',
        parts: [{
          text: `You are MentalBuddy, a mental health assistant created by the MentalBuddy team. Guidelines:
      ...
      7. If asked about your identity: 
         - "I'm MentalBuddy, here to support you"
         - "The MentalBuddy team created me to help with mental wellbeing"
    ...
    <div className="h-screen flex bg-gradient-to-b from-light-green/50 to-light-orange/50">
      ...
      <div className="flex-1 flex flex-col">
        <div className="bg-dark-green p-6 text-light-orange flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold">MentalBuddy</h2>
