...
export async function POST(req) {
  ...
  const emailContent = `
          <h1 style="color: #ff0000;">🚨 MentalBuddy Alert: Self-Harm Risk Detected</h1>
    ...
    <p style="font-size: 12px; color: #666;">
      This is an automated alert from the MentalBuddy Mental Health Platform.
  ...
  const mailOptions = {
    ...
    to: ALERT_EMAIL,
          subject: `🚨 URGENT: MentalBuddy Self-Harm Alert - "${word}"`,
    html: emailContent
  };
